...
public class Parser {
    ...
    static void processExpression(TransactionId tid, ZExpression wx, HashMap<String,DbIterator> tableMap, HashMap<String,String> equivMap) throws ParsingException , NoSuchFieldException {
    ...
    public static DbIterator parseQuery(TransactionId tid, ZQuery q) throws IOException, Zql.ParseException, ParsingException, NoSuchFieldException {
        @SuppressWarnings("unchecked")
    ...
    public static void handleQueryStatement(ZQuery s) throws TransactionAbortedException, DbException, IOException, ParsingException, Zql.ParseException, NoSuchFieldException  {
        // and run it
        DbIterator node;
    ...
    public static void handleInsertStatement(ZInsert s) throws TransactionAbortedException, DbException, IOException, ParsingException, Zql.ParseException, NoSuchFieldException   {
        int id;
        try {
    ...
    public static void handleDeleteStatement(ZDelete s) throws TransactionAbortedException, DbException, IOException, ParsingException, Zql.ParseException, NoSuchFieldException   {
        HashMap<String, DbIterator> tableMap = new HashMap<String, DbIterator>();
    ...
    public static void processNextStatement(InputStream is) throws NoSuchFieldException {
        try {
...
class PredicateInfo {
    ...
    public void checkJoinPredicate( TransactionId tid, boolean isTableField, ZExp exp,  HashMap<String,DbIterator> tableMap, HashMap<String,String> equivMap ) throws ParsingException , NoSuchFieldException {
